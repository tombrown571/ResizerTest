...
using ResizerTestCore.ImageSharp;

namespace ResizerTestCore
{
    ...
    public class Program
    {
        ...
        {"ImageResizer", "ImageProcessor", "ImageSharp", "SkiaSharp", "CoreCompat"};

        private static string[] _imageSharpAlgorithms = new[]
        {"Bicubic", "Triangle", "NearestNeighbor", "MitchellNetravali"};
        ...
        static void Main(string[] args)
        {
            ...
            var finishMessage2 = string.Format("*** Run Details: Processor: {0}  Threads: {1} {2}  *** ", imageType,
                _runCount, (imageType == "ImageSharp" ? string.Format("Algorithm: {0}", _imageSharpAlgorithm) : ""));
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine(
                "     : {0} [<Algorithm,  ({1})>]  'optional ImageSharp Resampler Algorithm: default {2}'",
                "".PadLeft(_ProgName.Length), string.Join("|", _imageSharpAlgorithms), _imageSharpAlgorithm);
        }
